...
export default class MachineService {
  ...
  public async deposit(amount: number, userId) {
  ...
  public async buy(userId, productId, productQuantity: number) {
  ...
  private async computeUserTotalOrders(userId, depositBalance: number) {
